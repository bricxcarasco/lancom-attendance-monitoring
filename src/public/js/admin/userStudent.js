$(function () {
    $("#tableUserStudentAccount").DataTable({
        "responsive": true,
        "autoWidth": false,
    });
});
...
$(document).ready(function () {
    // Table Buttons
    $('#tableUserStudentAccount').on('click', '.btn-edit-account', function() {
