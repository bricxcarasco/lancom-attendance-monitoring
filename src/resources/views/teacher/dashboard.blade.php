                ...
                <div class="card-body p-0">
                    ...
                    <nav aria-label="Schedule Navigation Panel">
                        <ul class="pagination float-right pagination-schedule">
                            <li class="page-item"><a class="page-link" href="{{ route ('teacher.search_date', ['date' => $weeklyData['prev_week_range']]) }}">Previous</a></li>
                            <li class="page-item"><a class="page-link" href="{{ route ('teacher.dashboard') }}">Now</a></li>
                            <li class="page-item"><a class="page-link" href="{{ route ('teacher.search_date', ['date' => $weeklyData['next_week_range']]) }}">Next</a></li>
                        </ul>
                    </nav>
