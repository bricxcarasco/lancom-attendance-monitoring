            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Teacher Accounts</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <table id="tableUserTeacherAccount" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
@include('admin.modals.teacher_account')
...
<script src="{{ asset('js/admin/userTeacher.js') }}"></script>
