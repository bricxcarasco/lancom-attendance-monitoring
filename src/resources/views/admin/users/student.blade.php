        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body p-2">
                    <table id="tableUserStudentAccount" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
@include('admin.modals.student_account')
...
<script src="{{ asset('js/admin/userStudent.js') }}"></script>
