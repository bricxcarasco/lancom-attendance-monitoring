    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-user"></i> Add Student Account</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="addAccountForm" action="{{ route('admin.users.student.add') }}" method="POST">
                @csrf
...
<div class="modal fade" id="edit-account-modal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><i class="fas fa-user-edit"></i> Edit Student Account</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="editAccountForm" action="{{ route('admin.users.student.edit') }}" method="POST">
                @csrf
                @method('PUT')
...
<div class="modal fade" id="change-password-account-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="changePasswordAccountForm" action="{{ route('admin.users.student.change_password') }}" method="POST">
                @csrf
                @method('PUT')
...
<div class="modal fade" id="enable-account-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="enableAccountForm" action="{{ route('admin.users.student.enable') }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="modal-body">
...
<div class="modal fade" id="disable-account-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="disableAccountForm" action="{{ route('admin.users.student.disable') }}" method="POST">
                @csrf
                @method('PATCH')
                <div class="modal-body">
...
<div class="modal fade" id="delete-account-modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="deleteAccountForm" action="{{ route('admin.users.student.delete') }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="modal-body">
