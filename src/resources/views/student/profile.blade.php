                                ...
                                <div class="active tab-pane" id="activity">
                                    ...
                                    <div class="timeline timeline-inverse">
                                        ...
                                        @foreach ($activities as $activity)
                                            ...
                                            @foreach ($activity['data'] as $each_data)
                                                <div>
                                                    <i class="fas {{ $each_data->class_type['image'] }}"></i>

                                                    <div class="timeline-item">
                                                        <span class="time"><i class="far fa-clock"></i> {{ $each_data->created_date_readable }}</span>

                                                        <h3 class="timeline-header">{{ $each_data->activity }}</h3>
